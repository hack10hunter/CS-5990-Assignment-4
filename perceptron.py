...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if a == 0 and accuracy > highestPerceptron:
               highestPerceptron = accuracy
               print("Highest Perceptron accuracy so far: " + str(highestPerceptron) + ", Parameters: learning rate=" + str(w) + ", shuffle=" + str(b))
            elif a != 0 and accuracy > highestMLP:
               highestMLP = accuracy
               print("Highest MLP accuracy so far: " + str(highestMLP) + ", Parameters: learning rate=" + str(w) + ", shuffle=" + str(b))
